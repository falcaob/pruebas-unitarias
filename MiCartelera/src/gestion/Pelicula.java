...
/**
 * Clase que representa una película. Contiene información sobre el título,
 * director y espectador asociado.
 * 
 * @author Irene
...
public class Pelicula {
	...
	/**
	 * Constructor de la clase Pelicula. Inicializa el título de la película y
	 * asigna un director predeterminado.
	 * 
	...
	// Video15
	/**
	 * Clase que representa una película en el cine. Esta clase almacena información
	 * sobre el titulo de la película, su director y el espectador que la ha
	 * reservado.
	 */
	public String toString() {
		String disponible;
		if (this.getEspectador() == null) {
			disponible = "Disponible";
		} else {
			disponible = "Comprobada para " + this.getEspectador().getNombre();
		}
		return this.getTitulo() + " de " + this.getDirector() + "; " + disponible;
	}
}
